...
const Navbar = () => {
  ...
  return (
    ...
    <nav className="navbar">
      <Link activeClass="active" to="intro" spy = {true} smooth={100} offset={-100} className="heading" >
        <img src={logo} alt=""  className="logo" />
      </Link>
      <div className="lap-menu">
        <Link activeClass="active" to="intro" spy = {true} smooth={100} offset={-100} className="menu-items" selected>Home</Link>
        <Link activeClass="active" to="About" spy={true}  smooth={100} offset={-100}  className="menu-items">About</Link>
    ...
    <a href="https://drive.google.com/file/d/1m4EVq2X_14Rju4wCi2yI1lPXcFl1x4zw/view?usp=drivesdk">  <button className="resume-btn">Resume</button></a>
      ...
      <div className="mob-menu" style={{display: showMenu? 'flex' : 'none'}}>
        ...
        <Link activeClass="active" to="intro" spy = {true} smooth={100} offset={-100} className="mob-menu-items"    onClick={()=>{
          setShowMenu(false)
        }} >Home</Link>
        ...
        <Link activeClass="active" to="more" spy={true} smooth={100} offset={-76} className="mob-menu-items"   onClick={()=>{
          setShowMenu(false)
        }}>More</Link>
        <a href="https://drive.google.com/file/d/1i5NVLLUStQ9vOxV9x6NXFFAulFaZ2m5c/view" className="mob-menu-items">  Resume</a>
      </div>
